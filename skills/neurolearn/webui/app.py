...
def _run_one(
    ...
    from skills.neurolearn.utils.resolver import ResolverFilters, resolve
...
def build_ui():
    ...
    import gradio as gr
    from skills.neurolearn.presets.loader import list_preset_names
...
def _handle_subscribes_add(channel_url, group):
    ...
    from skills.neurolearn.subscribes.cli import (
...
def _handle_subscribes_list():
    from skills.neurolearn.subscribes.cli import SUBSCRIBES_PATH
